        ...
        <div id="homePage">
            ...
            <div id="purpose">
                ...
                <div id="purposeContent">
                    <p>
                        We are developing a comprehensive database for a two-way RV marketplace.
                    ...
                    <br></br>
                    <p>
                        By doing so, the business owner can ensure data consistency is upheld to prevent misdocumentation or miscommunication when creating data on their  site.
                        With this, users can confidently interact with their site, knowing the information they fetch/see is managed securely and accurately. 
                    </p>
                </div>
            </div>
            <div id="projectInfo">
